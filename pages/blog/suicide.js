      ...
      <div className="flex">
        <div className="pl-18 lg:pl-32 w-full leading-relaxed">
          <h1 className="text-5xl font-bold mb-12">
            <span className="text-primary">Reality: </span>Stem Cells Open Developmental 'Blackbox' 
          </h1>
<p>
Almost a year after my graduation from highschool and  beautiful 3 months travelling through South America, I decided to go to the other side of the world; South East Asia.
</p>
<br />
<p>
...
Image analysis of a human gastruloid marked for anteroposterior patterning. Green shows the posterior (tail) end of the embryo and pink marks the posterior (head) end where heart cells would develop. Image credit: Naomi Moris, University of Cambridge.
To create this embryonic ‘blueprint’, the researchers treated embryonic stem cells with various chemical signals, inducing the formation of human gastruloids. Following a rigorous protocol, the researchers observed the differentiation of these embryonic stem cells into the three germ layers (endoderm, mesoderm and ectoderm) that later give rise to the neural, musculoskeletal and digestive systems. 
</p>
<br />
<p>
